...
pub enum Error {
    ...
    #[error("There was an error getting the Merkle candidate quote")]
    GetMerkleCandidateQuoteFailed,
    #[error("Failed to sign Merkle candidate node")]
    FailedToSignMerkleCandidate,
    #[error("Merkle payment verification failed")]
